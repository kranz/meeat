...
describe ConferencesController do
  ...
  let(:valid_attributes) { { "date" => "2013-05-15 16:59:30" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved conference as @conference" do
        ...
        post :create, {:conference => { "date" => "invalid value" }}, valid_session
        assigns(:conference).should be_a_new(Conference)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested conference" do
        ...
        Conference.any_instance.should_receive(:update_attributes).with({ "date" => "2013-05-15 16:59:30" })
        put :update, {:id => conference.to_param, :conference => { "date" => "2013-05-15 16:59:30" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the conference as @conference" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Conference.any_instance.stub(:save).and_return(false)
        put :update, {:id => conference.to_param, :conference => { "date" => "invalid value" }}, valid_session
        assigns(:conference).should eq(conference)
      end
