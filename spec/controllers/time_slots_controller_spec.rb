  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved time_slot as @time_slot" do
        ...
        post :create, {:time_slot => { "time_table_id" => "invalid value" }}, valid_session
        assigns(:time_slot).should be_a_new(TimeSlot)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested time_slot" do
        ...
        TimeSlot.any_instance.should_receive(:update_attributes).with({ "time_table_id" => "1" })
        put :update, {:id => time_slot.to_param, :time_slot => { "time_table_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the time_slot as @time_slot" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        TimeSlot.any_instance.stub(:save).and_return(false)
        put :update, {:id => time_slot.to_param, :time_slot => { "time_table_id" => "invalid value" }}, valid_session
        assigns(:time_slot).should eq(time_slot)
      end
